...
public class CustomWeekView extends WeekView {
    ...
    public CustomWeekView(Context context) {
        ...
        //原来颜色0xff489dff
        mSolarTermTextPaint.setColor(getResources().getColor(R.color.main_green));
        ...
        mPointPaint.setColor(getResources().getColor(R.color.main_green));
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, boolean hasScheme, boolean isSelected) {
        ...
        if (calendar.isWeekend() && calendar.isCurrentMonth()) {
            //原来颜色0xFF489dff
            mCurMonthTextPaint.setColor(getResources().getColor(R.color.main_green));
            mCurMonthLunarTextPaint.setColor(getResources().getColor(R.color.main_green));
            mSchemeTextPaint.setColor(getResources().getColor(R.color.main_green));
            mSchemeLunarTextPaint.setColor(getResources().getColor(R.color.main_green));
            mOtherMonthLunarTextPaint.setColor(getResources().getColor(R.color.main_green));
            mOtherMonthTextPaint.setColor(getResources().getColor(R.color.main_green));
        } else {
